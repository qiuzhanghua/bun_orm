...
require (
	...
	github.com/uptrace/bun/dialect/mssqldialect v1.1.11 // indirect
	github.com/uptrace/bun/dialect/pgdialect v1.1.11 // indirect
	github.com/uptrace/bun/dialect/sqlitedialect v1.1.11 // indirect
	github.com/uptrace/bun/driver/pgdriver v1.1.11 // indirect
	github.com/uptrace/bun/driver/sqliteshim v1.1.11 // indirect
